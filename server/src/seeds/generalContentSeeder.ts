...
const contentBlocks = [
  {
    slug: 'home-intro',
    title: 'Egypt Day Tours: Top Egypt Tours & Best Deals in 2025',
    subtitle: 'Experience Ancient Wonders with Local Experts',
    content: `
  ...
  {
    slug: 'footer-about',
    title: 'About JES Egypt Tours',
    subtitle: 'Your Gateway to Egypt',
    content: `
