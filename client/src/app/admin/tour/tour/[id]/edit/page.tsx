      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          tourForm.setFormData({
            name: tour.heading || tour.name || '',
            slug: tour.slug || '',
            description: {
              header: tour.Description?.header || '',
            ...
            seo: {
              ...
              metaKeywords: tour.seo?.metaKeywords || [],
        ...
        <div className="flex items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">
              {tourForm.formData.name || tourForm.formData.heading || 'Edit Tour'}
            </h1>
