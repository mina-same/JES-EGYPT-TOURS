      ...
      render: (faq: FAQ) => (
        <div className="faq-row-info">
          ...
          <div className="faq-content-wrapper">
            <div className="faq-question-text">{faq.question || 'Untitled FAQ'}</div>
            <div className="faq-answer-preview">
              {faq.answer ? (faq.answer.length > 100 ? faq.answer.substring(0, 100) + '...' : faq.answer) : 'No answer provided'}
            </div>
          </div>
        </div>
      ),
