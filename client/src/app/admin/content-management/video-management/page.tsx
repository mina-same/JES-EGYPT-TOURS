      ...
      render: (item) => (
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 max-w-[300px]">
            <div className="font-semibold text-sm text-gray-900 truncate" title={item.title}>{item.title}</div>
            <div className="text-xs text-[#b79c5c] font-medium">{item.tourName}</div>
