...
export const CARD_FIELDS =
  "slug,heading,name,images,gallery,priceStartingFrom,reviewsCount,videoLink,specialOfferDiscount,duration,tourLocation,subcategory,cardDescription,Description";
