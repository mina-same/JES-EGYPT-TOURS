...
/* Each partner has one logo. Every entry used to carry a `hoverImage` set
   to the very same import, which ClientCarousel rendered as a second
   <Image> stacked on the first. */
